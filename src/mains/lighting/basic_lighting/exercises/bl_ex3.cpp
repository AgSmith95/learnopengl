...
//    Wrapper::getInstance().setWindowSize(540, 960);
    ...
    Shader lightingShader(
        SHADERS_DIRECTORY "basic_lighting/exercises/ex3/basic_lighting.vsh",
        SHADERS_DIRECTORY "basic_lighting/exercises/ex3/basic_lighting.fsh"
    );
    Shader lightCubeShader(
        SHADERS_DIRECTORY "basic_lighting/light_cube.vsh",
        SHADERS_DIRECTORY "basic_lighting/light_cube.fsh"
    );
