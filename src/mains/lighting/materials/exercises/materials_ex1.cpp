...
//    Wrapper::getInstance().setWindowSize(540, 960);
    ...
    Shader lightingShader(
            SHADERS_DIRECTORY "materials/materials.vsh",
            SHADERS_DIRECTORY "materials/materials.fsh"
    );
    Shader lightCubeShader(
            SHADERS_DIRECTORY "materials/light_cube.vsh",
            SHADERS_DIRECTORY "materials/exercises/ex1/light_cube_ex1.fsh"
    );
    ...
    while(!glfwWindowShouldClose(Window))
    {
        ...
        // set correction for different components of the light
        glm::vec3 lightColor;
        lightColor.x = (float)sin(currentFrame * 2.0f);
        lightColor.y = (float)sin(currentFrame * 0.7f);
