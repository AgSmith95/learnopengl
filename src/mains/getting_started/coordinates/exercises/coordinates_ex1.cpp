...
int main()
{
    ...
    //                            FoV                  Aspect ratio
    projection = glm::perspective(glm::radians(60.0f), 1600.f / 900.f, 0.1f, 100.0f);
    //                            Bigger FoV - the more you see (the bigger the "cone of view")
    //                                                 higher AR makes everything more stretched out in Y direction
